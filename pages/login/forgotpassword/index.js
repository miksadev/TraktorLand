        ...
        <div className={styles.body}>
            ...
            <form onSubmit={(e) => this.onSubmit(e)}>
                <Form formname="Zaboravljena lozinka">
                    <Input onFocus={(e) => this.onFocus(e)} style={this.state.emailEmpty ? {borderBottom:'1px solid red'} : {}} onChange={(e) => this.onChange(e)} value={this.state.data.email} inputtype="input" label="E-mail" img="/login/email.svg" placeholder="mojaadresa@gmail.com" name="email" type="email"></Input>
