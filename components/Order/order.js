        ...
        <>
            ...
            <div className={styles.row}>
                ...
                <div className={styles.CartItems}>
                    ...
                    {order.map(item => { 
                        return <CartItem key={item.productid} isLogged={props.namena == order ? true : isLogged}key={item.id} edit={props.edit} sifra={item.code != undefined ? item.code : item.sifra} namena={props.namena} src={item.slika}
