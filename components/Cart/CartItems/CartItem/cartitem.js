...
const cartitem = (props) => {
    ...
    return(
        <div className={props.namena == "korpa" ? styles.cartitem : styles.checkoutitem}>
            ...
            {props.price != props.price2 && props.isLogged ? <p className={props.namena == "korpa" ? styles.price: styles.cprice}>{popust} RSD <span style={{textDecoration: "line-through",color:"red"}}>{props.price}</span></p> : 
